...
import { Bundle, Pair, PairDayData, Token, TokenDayData, UniswapDayData } from '../types/schema'
import { PairHourData } from './../types/schema'
import { loadBundle, loadFactory, loadPair, ONE_BI, usdPrice, ZERO_BD, ZERO_BI } from './helpers'
...
export function updateTokenDayData(token: Token, event: ethereum.Event): TokenDayData {
  ...
  if (tokenDayData === null) {
    ...
    tokenDayData.priceUSD = usdPrice(token, bundle)
